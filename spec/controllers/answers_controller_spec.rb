...
RSpec.describe AnswersController, type: :controller do
  ...
  describe 'GET #upvote' do
    ...
    context 'non author of the answer' do
      before do
        xhr :get, :upvote, id: @answer.id, format: :json
      end
    ...
    context 'author of answer' do
      it 'can not change the rating of his answer' do
        ...
        xhr :get, :upvote, id: @answer.id, format: :json
        @answer.reload
        expected_response_json = %({"id":"#{@answer.id}","errors":"Author can not vote for his answer"})
  ...
  describe 'GET #downvote' do
    ...
    context 'non author of the answer' do
      before do
        xhr :get, :downvote, id: @answer.id, format: :json
      end
      it 'assigns the requested answer to @answer' do
        expect(assigns(:answer)).to eq @answer
      end
